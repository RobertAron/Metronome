...
export function Footer() {
  return (
    <footer className="flex w-full flex-col items-center justify-between gap-2 p-2">
      <DarkModeToggle />
      <span className="text-sx">
        Made with <span style={{ color: "#e25555" }}>♥</span> on{" "}
        <a
          target="_blank"
          href="https://github.com/RobertAron/Metronome"
          rel="noreferrer"
