      ...
      {new Array(6).fill(null).map((_, index) => {
        ...
        return (
          <ToggleGroup.Item
            ...
            className="flex grow items-baseline justify-center border-x-[.5px] border-y border-zinc-900 px-3 py-1 text-lg first:rounded-l first:border-l last:rounded-r last:border-r hover:bg-amber-50 focus:z-10 focus:border-amber-500 focus:shadow-[0_0_0_2px] focus:shadow-amber-500 focus:outline-none data-[state=on]:bg-slate-900 data-[state=on]:text-white"
          >
